...
def process_write(event):
    try:
        ...
        if response['ResponseMetadata']['HTTPStatusCode'] == 200:
            ...
            return {'status': 'Failed', 'message': 'Object not added!', 'response': response}
    except Exception as e:
        return {'Status': 'Error', 'message': str(e)}


json_event = {'Records': [{'s3': {'bucket': {
    'name': get_bucket_names()['ingestion']}, 'object': {'key': '2024/5/20/12/2024-05-20 12:44:16.029157.json'}}}]}
